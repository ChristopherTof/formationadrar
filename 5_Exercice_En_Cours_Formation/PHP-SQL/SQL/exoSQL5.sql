...
SELECT * FROM produit WHERE prix_produit BETWEEN 2 AND 10;
...
SELECT nom_vendeur, prenom_vendeur, id_ticket FROM ticket
RIGHT JOIN vendeur ON ticket.id_vendeur = vendeur.id_vendeur
