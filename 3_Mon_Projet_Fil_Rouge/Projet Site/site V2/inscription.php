...
<body>
    ...
    <section class="container-fluid p-0">
        ...
        <article class="container d-flex flex-wrap px-4 px-lg-0">
            ...
            <form action="./controller/ctrl_users.php" method="POST" class="container d-flex flex-wrap px-0 needs-validation mb-5" enctype="multipart/form-data" novalidate>
                ...
                <div class="col-12 col-lg-5 offset-lg-2 mb-3">
                    ...
                    <input type="password" name="mdp_verif" id="mdp_verif" class="form-control" required>
                    <div class="invalid-feedback">Verification du mot de passe obligatoire</div>
                </div>

                <div class="col-12 col-lg-5 mb-3">
                    <label for="img_users" class="form-label">Choisir une photo de profil (facultatif)</label>
                    <input type="file" name="img_users" id="image_users" class="form-control">                    
                </div>
