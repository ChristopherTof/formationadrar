...
<body>
    ...
    <section class="container-fluid p-0">
        ...
        <article class="container d-flex flex-wrap px-4 px-lg-0">
            ...
            <form class="container d-flex flex-wrap px-0 needs-validation mb-5" novalidate>

                <div class="col-12 col-lg-5 mb-3">
                    <label for="inscripFirstN" class="form-label">Nom*</label>
                ...
                <div class="col-12 text-center">
                    <button type="submit" class="col-4 btn btn2">Inscription</button>
                </div>
            </form>
        </article>
    </section>
